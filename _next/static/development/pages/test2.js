...
var e="undefined"!=typeof window&&window.AndroidBridge,n="undefined"!=typeof window&&window.webkit&&window.webkit.messageHandlers,r=function(){var r=[];"undefined"!=typeof window&&window.addEventListener("aituEvents",function(e){[].concat(r).map(function(n){return n.call(null,e)})});var t,o,i,d,u=function(e){r.push(e)};return{invoke:(t=u,o={current:0,next:function(){return++this.current}},i={},d={add:function(e,n){var r=null!=n?n:o.next();return i[r]=e,r},resolve:function(e,n,r,t){var o=i[e];o&&(r(t)?o.resolve(n):o.reject(t),i[e]=null)}},t(function(e){if(e.detail&&"reqId"in e.detail){var n=e.detail,r=n.reqId;r&&d.resolve(r,n.data,function(e){return!e},n.error)}}),function(r,t){return void 0===t&&(t={}),new Promise(function(o,i){!function(r,t,o){void 0===o&&(o={});var i=n&&n.invoke;e&&e.invoke?e.invoke(r,t,JSON.stringify(o)):i?n.invoke.postMessage({reqId:r,method:t,data:o}):"undefined"!=typeof window&&(console.log("isWeb"),console.log(r,t,o))}(d.add({resolve:o,reject:i},t.reqId),r,t)})}),storage:function(e,n){var r,t,o=(r={current:0,next:function(){return++this.current}},t={},{add:function(e,n){var o="s"+(null!=n?n:r.next());return t[o]=e,o},resolve:function(e,n,r,o){var i=t[e];i&&(r(o)?i.resolve(n):i.reject(o),t[e]=null)}});return n(function(e){if(e.detail&&"reqId"in e.detail){var n=e.detail,r=n.reqId;r&&o.resolve(r,n.data,function(e){return!e},n.error)}}),{setItem:function(n,r){return new Promise(function(t,i){var d=o.add({resolve:t,reject:i});e(d,"setItem",{keyName:n,keyValue:r})})},getItem:function(n){return new Promise(function(r,t){var i=o.add({resolve:r,reject:t});e(i,"getItem",{keyName:n})})},removeItem:function(n){return new Promise(function(r,t){var i=o.add({resolve:r,reject:t});e(i,"removeItem",{keyName:n})})},key:function(n){return new Promise(function(r,t){var i=o.add({resolve:r,reject:t});e(i,"key",{index:n})})},clear:function(){return new Promise(function(n,r){var t=o.add({resolve:n,reject:r});e(t,"key",{})})}}}(function(r,t,o){void 0===o&&(o={});var i=n&&n.storage;e&&e.storage?e.storage(r,t,JSON.stringify(o)):i?n.storage.postMessage({reqId:r,method:t,data:o}):"undefined"!=typeof window&&(console.log("---S-----isWeb"),console.log(r,t,o))},u),isSupported:function(){return e||n},sub:u}}();/* harmony default export */ __webpack_exports__["default"] = (r);
