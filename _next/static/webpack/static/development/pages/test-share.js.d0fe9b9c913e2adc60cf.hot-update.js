...
function Test(_ref) {
  ...
  var fileInput = document.querySelector("input"); // listen for the change event so we can capture the file

  fileInput.addEventListener("change", function (e) {
    // get a reference to the file
    var file = e.target.files[0]; // encode the file using the FileReader API

    var reader = new FileReader();

    reader.onloadend = function () {
      // use a regex to remove data url part
      var base64String = reader.result.replace("data:", "").replace(/^.+,/, ""); // log to console
      // logs wL2dvYWwgbW9yZ...
...
//# sourceMappingURL=test-share.js.d0fe9b9c913e2adc60cf.hot-update.js.map