...
var speakers = [{
  ...
  talkContent: 'В докладе я расскажу:\n- как запрашивать связанные сущности без дополнительных запросов - фильтрация, пагинация - все проблемы уже решены - как писать меньше однотипного кода на клиенте, на примере redux',
  img: anton
}, {
  name: 'Виталий Потапов',
  desc: 'Москва, Яндекс',
  talkTitle: 'Как и зачем разрабатывать свой скилл для Алисы',
  talkContent: '* - Привет, Алиса! Зачем мне делать для тебя свой навык?...- А можно как-то быстро попробовать и посмотреть, что получится?...- Окей, делаю... Какие инструменты лучше использовать? И как вообще это тестировать?...- Готово! Куда деплоить?... - Алиса! Я вижу в логах, что пользователи называют мой навык нехорошими словами! Что мне делать?!... Все ответы вд окладе 🙂',
  img: vitalik
}, {
...
//# sourceMappingURL=index.js.9494260312dd5dee85cd.hot-update.js.map