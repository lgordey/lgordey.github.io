        ...
        <div>
          ...
          >
            <Panel header="Для кого?" {...panelProps}>
              <b>8 июня</b> митап (или конференция?) <b>AstanaJS</b> приглашает всех, кто пишет на JavaScript. А также всех, кому интересно узнать больше о frontend-разработке — бэкендеров, тестировщиков, дизайнеров, менеджеров, и студентов, которые планируют карьеру в IT.
